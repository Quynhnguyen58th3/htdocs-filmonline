...
<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="collapsibleNavbar">
					...
					<ul class="navbar-nav ">
						...
						<li class="nav-item icon-home"><a href="#"><i class="fas fa-home"></a></i></li>
						<!-- Dropdown -->
	...
	<div id="login" class="col-md-8"><!----cái bao chung cho nhung thg con o ben trong-->
		<div class="main">  
			<!----in trong có 1 div cho titile và các khung con-->
					<h2> Đăng nhập </h2>
